...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"              : '/home/slamtec/lvcheng/code/obj_detection_ws/src/yolov8_main/yolov8_main/model_data/yolov8_s.pth',
        "classes_path"            : '/home/slamtec/lvcheng/code/obj_detection_ws/src/yolov8_main/yolov8_main/model_data/coco_classes.txt',
        #---------------------------------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            object_detection.label = predicted_class
            object_detection.confidence = float(score)
            object_detection.left = int(left)
            object_detection.top = int(top)
            object_detection.right = int(right)
            object_detection.bottom = int(bottom)

            detection_result.objects.append(object_detection)
